...
#include <stan/math/rev/fun/boost_fpclassify.hpp>
#include <stan/math/rev/fun/boost_isfinite.hpp>
#include <stan/math/rev/fun/boost_isnormal.hpp>
...
#include <stan/math/rev/fun/ibeta.hpp>

...
void test_to_matrix_array_answers(int m, int n) {
  ...
  for (int i = 0; i < m * n; ++i)
    a(i) = i;
  stan::test::expect_matrix_eq(a, to_matrix(vec, m, n));
  stan::test::expect_matrix_eq(a, to_matrix(vec, m, n, 1));
  stan::test::expect_matrix_eq(a, to_matrix(vec, m, n, -1));
  stan::test::expect_matrix_eq(a, to_matrix(vec, m, n, 2));
  stan::test::expect_matrix_eq(a, row_major_to_column_major(to_matrix(vec, m, n, 0)));
  stan::test::expect_matrix_eq(a, to_matrix(vec_int, m, n));
  stan::test::expect_matrix_eq(a, to_matrix(vec_int, m, n, 1));
  stan::test::expect_matrix_eq(a, row_major_to_column_major(to_matrix(vec_int, m, n, 0)));
}
...
void test_to_matrix_matrix_answers(int m, int n) {
  ...
  for (int i = 0; i < m * n; ++i)
    a(i) = i;
  stan::test::expect_matrix_eq(a, to_matrix(a));
}
...
void test_to_matrix_matrix_reshape_answers(int m1, int n1, int m2, int n2) {
  ...
  stan::test::expect_matrix_eq(a, to_matrix(b, m1, n1));
  stan::test::expect_matrix_eq(a, to_matrix(b, m1, n1, 1));
  stan::test::expect_matrix_eq(a, to_matrix(b, m1, n1, -1));
  stan::test::expect_matrix_eq(a, to_matrix(b, m1, n1, 2));
  stan::test::expect_matrix_eq(a, row_major_to_column_major(to_matrix(b, m1, n1, 0)));

  stan::test::expect_matrix_eq(b, to_matrix(a, m2, n2));
  stan::test::expect_matrix_eq(b, to_matrix(a, m2, n2, 1));
  stan::test::expect_matrix_eq(b, row_major_to_column_major(to_matrix(a, m2, n2, 0)));
...
void test_to_vector_matrix_answers(int m, int m2, int n2) {
  ...
  // without reshape
  stan::test::expect_matrix_eq(c, to_matrix(a));

  // with reshape
  stan::test::expect_matrix_eq(b, to_matrix(a, m2, n2));
  stan::test::expect_matrix_eq(b, to_matrix(a, m2, n2, 1));
  stan::test::expect_matrix_eq(b, to_matrix(a, m2, n2, -1));
  stan::test::expect_matrix_eq(b, to_matrix(a, m2, n2, 2));
  stan::test::expect_matrix_eq(b, row_major_to_column_major(to_matrix(a, m2, n2, 0)));
...
void test_to_matrix_2darray_answers(int m, int n) {
  ...
  stan::test::expect_matrix_eq(a, to_matrix(vec));
  stan::test::expect_matrix_eq(a, to_matrix(vec_int));
}

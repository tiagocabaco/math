...
TEST(MathMatrixPrimMat, matrix_exp_0x0) {
  ...
  stan::test::expect_matrix_eq(m1, stan::math::matrix_exp(m1));
}
...
TEST(MathMatrixPrimMat, matrix_exp_1x1) {
  ...
  stan::test::expect_matrix_eq(m2, stan::math::matrix_exp(m1));
}
...
TEST(MathMatrixPrimMat, matrix_exp_2x2_2) {
  ...
  stan::test::expect_matrix_eq(exp_m, stan::math::matrix_exp(m));
}

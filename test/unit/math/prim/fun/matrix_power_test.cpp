...
TEST(MathMatrixPower, two_by_two) {
  ...
  stan::test::expect_matrix_eq(I, matrix_power(M, 0));
  stan::test::expect_matrix_eq(M, matrix_power(M, 1));
  stan::test::expect_matrix_eq(M2, matrix_power(M, 2));
  stan::test::expect_matrix_eq(M3, matrix_power(M, 3));
  stan::test::expect_matrix_eq(M9, matrix_power(M, 9));
}
...
TEST(MathMatrixPower, compare_to_simple_impl) {
  ...
  stan::test::expect_matrix_eq(expected, matrix_power(M, exponent));
}
...
TEST(MathMatrixPower, matrix_power_operator) {
  ...
  stan::test::expect_matrix_eq(M2, M ^ 2);
}

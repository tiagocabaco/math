...
TEST(AgradMixMatrixAddons, matrix_fv) {
  ...
  stan::test::expect_matrix_eq(vals, mat_in.val().val());
  stan::test::expect_matrix_eq(vals.array().exp(), mat_in.val().val().array().exp());

  stan::test::expect_matrix_eq(derivs, mat_in.d().val());
  stan::test::expect_matrix_eq(derivs.array().exp(), mat_in.d().val().array().exp());
...
TEST(AgradMixMatrixAddons, matrix_ffv) {
  ...
  stan::test::expect_matrix_eq(vals, mat_in.val().val().val());
  stan::test::expect_matrix_eq(vals.array().exp(), mat_in.val().val().val().array().exp());

  stan::test::expect_matrix_eq(derivs, mat_in.d().val().val());
  stan::test::expect_matrix_eq(derivs.array().exp(), mat_in.d().val().val().array().exp());
...
TEST(AgradMixMatrixAddons, vector_fv) {
  ...
  stan::test::expect_matrix_eq(vals, vec_in.val().val());
  stan::test::expect_matrix_eq(vals.array().exp(), vec_in.val().val().array().exp());

  stan::test::expect_matrix_eq(derivs, vec_in.d().val());
  stan::test::expect_matrix_eq(derivs.array().exp(), vec_in.d().val().array().exp());
...
TEST(AgradMixMatrixAddons, vector_ffv) {
  ...
  stan::test::expect_matrix_eq(vals, vec_in.val().val().val());
  stan::test::expect_matrix_eq(vals.array().exp(), vec_in.val().val().val().array().exp());

  stan::test::expect_matrix_eq(derivs, vec_in.d().val().val());
  stan::test::expect_matrix_eq(derivs.array().exp(), vec_in.d().val().val().array().exp());
...
TEST(AgradMixMatrixAddons, row_vector_fv) {
  ...
  stan::test::expect_matrix_eq(vals, row_vec_in.val().val());
  stan::test::expect_matrix_eq(vals.array().exp(), row_vec_in.val().val().array().exp());

  stan::test::expect_matrix_eq(derivs, row_vec_in.d().val());
  stan::test::expect_matrix_eq(derivs.array().exp(), row_vec_in.d().val().array().exp());
...
TEST(AgradMixMatrixAddons, row_vector_ffv) {
  ...
  stan::test::expect_matrix_eq(vals, row_vec_in.val().val().val());
  stan::test::expect_matrix_eq(vals.array().exp(),
                   row_vec_in.val().val().val().array().exp());

  stan::test::expect_matrix_eq(derivs, row_vec_in.d().val().val());
  stan::test::expect_matrix_eq(derivs.array().exp(),

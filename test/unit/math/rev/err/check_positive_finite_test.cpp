...
TEST(AgradRevErrorHandlingScalar_arr, CheckPositiveFinite_Vector) {
  const char* function = "check_positive_finite";
  std::vector<var> x;
...
TEST(AgradRevErrorHandlingScalar_arr, CheckPositiveFiniteVarCheckVectorized) {
  using stan::math::check_positive_finite;
  using stan::math::var;
  using std::vector;
...
TEST(AgradRevErrorHandlingScalar_mat, CheckPositiveFinite_Matrix) {
  const char* function = "check_positive_finite";

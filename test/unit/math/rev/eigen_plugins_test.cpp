...
TEST(AgradRevMatrixAddons, var_matrix) {
  ...
  stan::test::expect_matrix_eq(vals, mat_in.val());
  stan::test::expect_matrix_eq(vals.val(), mat_in.val());
  stan::test::expect_matrix_eq(vals.array().exp(), mat_in.val().array().exp());

  stan::test::expect_matrix_eq(derivs, mat_in.adj());
  stan::test::expect_matrix_eq(derivs.array().exp(), mat_in.adj().array().exp());
  ...
  stan::test::expect_matrix_eq(vals, mat_vi.val());
  stan::test::expect_matrix_eq(vals.array().exp(), mat_vi.val().array().exp());

  stan::test::expect_matrix_eq(derivs, mat_vi.adj());
  stan::test::expect_matrix_eq(derivs.array().exp(), mat_vi.adj().array().exp());
...
TEST(AgradRevMatrixAddons, var_vector) {
  ...
  stan::test::expect_matrix_eq(vals, vec_in.val());
  stan::test::expect_matrix_eq(vals.array().exp(), vec_in.val().array().exp());

  stan::test::expect_matrix_eq(derivs, vec_in.adj());
  stan::test::expect_matrix_eq(derivs.array().exp(), vec_in.adj().array().exp());
  ...
  stan::test::expect_matrix_eq(vals, vec_vi.val());
  stan::test::expect_matrix_eq(vals.array().exp(), vec_vi.val().array().exp());

  stan::test::expect_matrix_eq(derivs, vec_vi.adj());
  stan::test::expect_matrix_eq(derivs.array().exp(), vec_vi.adj().array().exp());
...
TEST(AgradRevMatrixAddons, var_row_vector) {
  ...
  stan::test::expect_matrix_eq(vals, row_vec_in.val());
  stan::test::expect_matrix_eq(vals.array().exp(), row_vec_in.val().array().exp());

  stan::test::expect_matrix_eq(derivs, row_vec_in.adj());
  stan::test::expect_matrix_eq(derivs.array().exp(), row_vec_in.adj().array().exp());
  ...
  stan::test::expect_matrix_eq(vals, row_vec_vi.val());
  stan::test::expect_matrix_eq(vals.array().exp(), row_vec_vi.val().array().exp());

  stan::test::expect_matrix_eq(derivs, row_vec_vi.adj());
  stan::test::expect_matrix_eq(derivs.array().exp(), row_vec_vi.adj().array().exp());

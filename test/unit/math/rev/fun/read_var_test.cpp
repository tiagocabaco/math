...
TEST(AgradRevMatrix, read_var_mat) {
  ...
  stan::test::expect_matrix_eq(matrix_var.val(), matrix_val);
  stan::test::expect_matrix_eq(matrix_var.adj(), matrix_deriv);
  ...
  stan::test::expect_matrix_eq(matrix_vari.val(), matrix_val);
  stan::test::expect_matrix_eq(matrix_vari.adj(), matrix_deriv);

  matrix_val.setZero();
  matrix_vi matrix_vi2(100, 100);
  read_vi_val(matrix_var, matrix_vi2, matrix_val);
  stan::test::expect_matrix_eq(matrix_var.val(), matrix_val);
  stan::test::expect_matrix_eq(matrix_var.val(), matrix_vi2.val());
  stan::test::expect_matrix_eq(matrix_var.adj(), matrix_vi2.adj());

  matrix_deriv.setZero();
  matrix_vi matrix_vi3(100, 100);
  read_vi_adj(matrix_var, matrix_vi3, matrix_deriv);
  stan::test::expect_matrix_eq(matrix_var.adj(), matrix_deriv);
  stan::test::expect_matrix_eq(matrix_var.val(), matrix_vi3.val());
  stan::test::expect_matrix_eq(matrix_var.adj(), matrix_vi3.adj());
}
...
TEST(AgradRevMatrix, read_var_vec) {
  ...
  stan::test::expect_matrix_eq(vector_var.val(), vector_val);
  stan::test::expect_matrix_eq(vector_var.adj(), vector_deriv);

  vector_val.setZero();
  vector_deriv.setZero();
  read_val_adj(vector_vari, vector_val, vector_deriv);
  stan::test::expect_matrix_eq(vector_vari.val(), vector_val);
  stan::test::expect_matrix_eq(vector_vari.adj(), vector_deriv);

  vector_val.setZero();
  vector_vi vector_vi2(100);
  read_vi_val(vector_var, vector_vi2, vector_val);
  stan::test::expect_matrix_eq(vector_var.val(), vector_val);
  stan::test::expect_matrix_eq(vector_var.val(), vector_vi2.val());
  stan::test::expect_matrix_eq(vector_var.adj(), vector_vi2.adj());

  vector_deriv.setZero();
  vector_vi vector_vi3(100);
  read_vi_adj(vector_var, vector_vi3, vector_deriv);
  stan::test::expect_matrix_eq(vector_var.adj(), vector_deriv);
  stan::test::expect_matrix_eq(vector_var.val(), vector_vi3.val());
  stan::test::expect_matrix_eq(vector_var.adj(), vector_vi3.adj());
}
...
TEST(AgradRevMatrix, read_var_rowvec) {
  ...
  read_vi_val_adj(row_vector_var, row_vector_vari, row_vector_val,
                  row_vector_deriv);
  stan::test::expect_matrix_eq(row_vector_var.val(), row_vector_val);
  stan::test::expect_matrix_eq(row_vector_var.adj(), row_vector_deriv);

  row_vector_val.setZero();
  row_vector_deriv.setZero();
  read_val_adj(row_vector_vari, row_vector_val, row_vector_deriv);
  stan::test::expect_matrix_eq(row_vector_vari.val(), row_vector_val);
  stan::test::expect_matrix_eq(row_vector_vari.adj(), row_vector_deriv);

  row_vector_val.setZero();
  row_vector_vi row_vector_vi2(100);
  read_vi_val(row_vector_var, row_vector_vi2, row_vector_val);
  stan::test::expect_matrix_eq(row_vector_var.val(), row_vector_val);
  stan::test::expect_matrix_eq(row_vector_var.val(), row_vector_vi2.val());
  stan::test::expect_matrix_eq(row_vector_var.adj(), row_vector_vi2.adj());

  row_vector_deriv.setZero();
  row_vector_vi row_vector_vi3(100);
  read_vi_adj(row_vector_var, row_vector_vi3, row_vector_deriv);
  stan::test::expect_matrix_eq(row_vector_var.adj(), row_vector_deriv);
  stan::test::expect_matrix_eq(row_vector_var.val(), row_vector_vi3.val());
  stan::test::expect_matrix_eq(row_vector_var.adj(), row_vector_vi3.adj());
}
...
TEST(AgradRevMatrix, read_var_expr) {
  ...
  stan::test::expect_matrix_eq(matrix_var.diagonal().val(), vector_val);
  stan::test::expect_matrix_eq(matrix_var.diagonal().adj(), vector_deriv);
  ...
  stan::test::expect_matrix_eq(matrix_var.diagonal().val(), vector_val);
  stan::test::expect_matrix_eq(matrix_var.diagonal().val(), vector_vari2.val());
  stan::test::expect_matrix_eq(matrix_var.diagonal().adj(), vector_vari2.adj());

  vector_deriv.setZero();
  vector_vi vector_vari3(100);
  read_vi_adj(matrix_var.diagonal(), vector_vari3, vector_deriv);
  stan::test::expect_matrix_eq(matrix_var.diagonal().adj(), vector_deriv);
  stan::test::expect_matrix_eq(matrix_var.diagonal().val(), vector_vari3.val());
  stan::test::expect_matrix_eq(matrix_var.diagonal().adj(), vector_vari3.adj());
}

...
TEST(MetaTraits_arr, VectorBuilderHelper_false_true) {
  using stan::VectorBuilderHelper;
  using stan::length;
  using stan::math::var;
  using std::vector;
...
TEST(MetaTraits_arr, VectorBuilderHelper_true_true) {
  using stan::VectorBuilderHelper;
  using stan::length;
  using stan::math::var;
  using std::vector;
...
TEST(MetaTraits_mat, VectorBuilderHelper_false_true) {
  using Eigen::Dynamic;
  using Eigen::Matrix;
  using stan::VectorBuilderHelper;
  using stan::length;
...
TEST(MetaTraits_mat, VectorBuilderHelper_true_true) {
  using Eigen::Dynamic;
  using Eigen::Matrix;
  using stan::VectorBuilderHelper;
  using stan::length;

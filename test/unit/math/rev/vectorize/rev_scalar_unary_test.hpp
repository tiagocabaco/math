#ifndef TEST_UNIT_MATH_REV_VECTORIZE_REV_SCALAR_UNARY_TEST_HPP
#define TEST_UNIT_MATH_REV_VECTORIZE_REV_SCALAR_UNARY_TEST_HPP

#include <stan/math/rev.hpp>
#include <test/unit/math/prim/vectorize/expect_types.hpp>
#include <test/unit/math/rev/vectorize/expect_rev_values.hpp>
#include <test/unit/math/rev/vectorize/expect_rev_errors.hpp>

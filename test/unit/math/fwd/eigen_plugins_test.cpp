...
TEST(AgradFwdMatrixAddons, fvar_double_matrix) {
  ...
  stan::test::expect_matrix_eq(derivs, mat_in.d());
  stan::test::expect_matrix_eq(derivs.array().exp(), mat_in.d().array().exp());
...
TEST(AgradFwdMatrixAddons, fvar_double_vector) {
  ...
  stan::test::expect_matrix_eq(derivs, vec_in.d());
  stan::test::expect_matrix_eq(derivs.array().exp(), vec_in.d().array().exp());
...
TEST(AgradFwdMatrixAddons, fvar_double_rowvector) {
  ...
  stan::test::expect_matrix_eq(derivs, row_vec_in.d());
  stan::test::expect_matrix_eq(derivs.array().exp(), row_vec_in.d().array().exp());

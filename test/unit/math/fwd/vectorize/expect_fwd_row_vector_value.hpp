#ifndef TEST_UNIT_MATH_FWD_VECTORIZE_EXPECT_FWD_ROW_VECTOR_VALUE_HPP
#define TEST_UNIT_MATH_FWD_VECTORIZE_EXPECT_FWD_ROW_VECTOR_VALUE_HPP

#include <stan/math/fwd.hpp>
#include <test/unit/math/fwd/vectorize/build_fwd_matrix.hpp>

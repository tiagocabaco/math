...
TEST(AgradPartialsVari_mat, OperandsAndPartialsFvarScal) {
  using stan::math::fvar;
  using stan::math::operands_and_partials;
...
TEST(AgradPartialsVari_mat, OperandsAndPartialsFvarVec) {
  using stan::math::fvar;
  using stan::math::operands_and_partials;
...
TEST(AgradPartialsVari_mat, OperandsAndPartialsFvarMat) {
  using stan::math::fvar;
  using stan::math::operands_and_partials;
